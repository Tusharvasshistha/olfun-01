...
function whatsapp1(){
  ...
  if(location=='Indore'){
    var url = "https://wa.me/9991212077?text=Please confirm my booking for "+date+" on behalf of "+name+" for your centre at "+location+"";
  }
  else{
  var url = "https://wa.me/7988732624?text=Please confirm my booking for "+date+" on behalf of "+name+" for your centre at "+location+"";
  }
  ...
  function whatsapp2(){
    ...
    var url = "https://wa.me/7988732624?text="
    +query+"";
    window.open(url,'_blank').focus();
    }
    ...
    function whatsapp3(){
      ...
      var url = "https://wa.me/7988732624?text=Name "+name+"Mail "+email+" city "+city+" I would like to enquire the following "+message+"";
      window.open(url,'_blank').focus();
      }
